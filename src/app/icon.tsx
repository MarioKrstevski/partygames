...
/**
 * App icon: the violet-to-pink gradient the whole app is built on, with
 * confetti and a glass. Drawn rather than shipped as a binary so there is no
 * asset to keep in sync with the palette, and so it is crisp at every size.
 */
