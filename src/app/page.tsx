...
export default async function Home() {
  ...
  const nhieIn = ["en", "fr", "es"]
    .map((lang) => showcase.find((d) => d.gameType === "neverhaveiever" && d.language === lang))
        ...
        <section className="mx-auto grid w-full max-w-6xl items-center gap-12 px-4 pb-16 pt-12 sm:px-6 lg:grid-cols-[1fr_1.15fr] lg:gap-10 lg:pb-24 lg:pt-20">
          <div>
            <h1 className="hook text-[2.25rem] font-extrabold leading-[1.02] tracking-[-0.03em] text-white sm:text-5xl lg:text-[3.4rem]">
              Every party game, in one place.
            </h1>
            <p className="mt-6 max-w-lg text-lg leading-relaxed text-zinc-300">
              No apps to install, no subscriptions to buy. Open the page, pass
              the phone around, and pick from dozens of ready-made decks — it
              even works when the wifi doesn&apos;t.
            </p>
            <div className="mt-8 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
              <ButtonLink href="/games" className="h-auto w-full px-6 py-3.5 text-base sm:w-auto">
                Start playing now
              </ButtonLink>
          ...
          <div className="mx-auto grid w-full max-w-6xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_1.1fr] lg:gap-16 lg:py-24">
            ...
            <div>
              ...
              <p className="mt-5 text-lg leading-relaxed text-zinc-300">
                The built-in decks are the starting point. Never Have I Ever
                ships in English, French and Spanish today, and any deck you
                write can be in any language — the confessions only your
                group gets.
              </p>
              ...
              <div className="mt-8 flex flex-col items-start gap-3 sm:flex-row sm:items-center">
                ...
                {nhieIn[1] && (
                  <Link
                    href={`/neverhaveiever/play/${nhieIn[1].id}`}
          ...
          <div className="mx-auto flex w-full max-w-6xl flex-col items-start gap-6 px-4 py-16 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:py-20">
            <div>
              ...
              <p className="mt-3 text-lg text-zinc-300">
                Pick a game and go. No download, no sign-up.
              </p>
            </div>
            <ButtonLink href="/games" className="h-auto px-7 py-4 text-base">
              Start playing now
            </ButtonLink>
          </div>
        </section>
